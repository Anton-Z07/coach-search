<script>
		    ...
		    columnDefs: [ 
		    	...
		    	{ targets: 5, orderable: false, 
		    		render: function ( data, type, row ) {
		    			...
		    			var edit = '<a class="text-primary-600" href="/admin/coaches/edit/'+data+'" title="Редактировать"><i class="icon-pencil7"></i></a>';
	...
	{
		if (confirm('Точно удалить тренера?'))
			Delete(id);
	}

	function Delete(id)
	{
		$.get('/admin/coaches/delete/'+id, function(){
			table.ajax.reload();
		});
	}
...
<div class="panel panel-flat">
	<div class="panel-heading">
		<div class="row">
			<a type="button" class="btn btn-success" style="float: right" href="/admin/coaches/edit" id="excel_button">Добавить тренера</a>
		</div>
	</div>
...
<div id="modal_balance" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="POST" class="form-horizontal" action="/admin/coaches/balance">
